                    ...
                    <div className="space-y-6">
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Upload employee information, salaries, and
                                    organizational data
                                </CardDescription>
                            </CardHeader>
                            <CardContent>
                        ...
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Upload historical payroll runs and configure
                        ...
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Upload CSV files with transaction history,
                                    employee records, or other bulk data
                                </CardDescription>
                            </CardHeader>
                            <CardContent>
                                <div className="space-y-4">
                                    ...
                                    <div className="text-xs text-gray-500">
                                        <p>
                                            Supported formats: CSV files with
                                            proper headers
                                        </p>
                    ...
                    <div className="space-y-6">
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Overview of your connected accounts and data
                                    sources
                                </CardDescription>
                            </CardHeader>
                            <CardContent>
                                    ...
                                    <div className="flex items-start gap-3">
                                        ...
                                        <div>
                                            ...
                                            <div className="text-sm text-blue-700 mt-1">
                                                Your system is ready for risk
                                                analysis. Consider connecting
                                                your accounting software for
